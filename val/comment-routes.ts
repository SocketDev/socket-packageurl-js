/**
 * @file Comment-route orchestrator. Composes the three comment-route modules
 *   (read, create, mutate) onto a shared Hono app. Split by lifecycle: reads
 *   are un-restricted for any authed user, create mints a new row with the JWT
 *   email as author, mutations (patch/delete) are gated on author-matches-JWT.
 */
