/**
 * @file Per-type injection character validation tests. Verifies that
 *   PackageURL rejects shell/URL injection characters in name and namespace
 *   components across all package ecosystems.
 */
