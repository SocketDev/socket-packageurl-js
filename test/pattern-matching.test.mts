...
describe('matches', () => {
  ...
  describe('wildcard in name', () => {
    ...
    it('should match middle wildcard', () => {
      const acmePluginReact = createTestPurl('npm', 'acme-plugin-react')
...
describe('createMatcher', () => {
  ...
  it('should handle all wildcard types', () => {
    ...
    const matchName = createMatcher('pkg:npm/acme-plugin-*')
    expect(matchName(createTestPurl('npm', 'acme-plugin-react'))).toBe(true)
