...
describe('Package exports', () => {
  ...
  describe('modular utility exports', () => {
    ...
    it('should export equalsPurls function', () => {
      expect(equalsPurls).toBeDefined()
      expect(typeof equalsPurls).toBe('function')
      expect(equalsPurls.name).toBe('equalsPurls')
      ...
      expect(equalsPurls(purl1, purl2)).toBe(true)
    })
    ...
    it('should export splitPurlPackageName function', () => {
      expect(splitPurlPackageName).toBeDefined()
      expect(typeof splitPurlPackageName).toBe('function')
      expect(splitPurlPackageName.name).toBe('splitPurlPackageName')

      // Test it works
      const result = splitPurlPackageName('composer', 'laravel/framework')
      expect(result).toEqual({
        namespace: 'laravel',
        name: 'framework',
      })
