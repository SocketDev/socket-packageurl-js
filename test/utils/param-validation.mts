...
export function testInvalidStringParam(
  ...
  testParam(paramName, paramMap, createArgs, [0, false, 1, true, {}], {
    shouldThrow: true,
  })
}
 ...
 * @param options.shouldThrow - Whether the values should cause errors.
 */
...
export function testValidParam(
  ...
  testParam(paramName, paramMap, createArgs, [paramName], {
    shouldThrow: false,
  })
}
