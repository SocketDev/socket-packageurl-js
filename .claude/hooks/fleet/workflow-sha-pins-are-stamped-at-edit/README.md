# workflow-sha-pins-are-stamped-at-edit
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "node .claude/hooks/fleet/workflow-sha-pins-are-stamped-at-edit/index.mts"
          }
        ]
      }
    ]
...
This hook lives in
[`socket-wheelhouse`](https://github.com/SocketDev/socket-wheelhouse/tree/main/template/.claude/hooks/workflow-sha-pins-are-stamped-at-edit)
