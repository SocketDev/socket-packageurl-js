...
This is a distinct concern from `package-manager-auto-update-is-disabled-at-edit` (which owns
...
Fails open on parse / payload errors (exit 0) - a guard bug must not block every
Bash call.
