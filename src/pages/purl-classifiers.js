...
;(() => {
  ...
  ns.looksLikePurl = text => {
    ...
    // Loose "type: namespace/name@version?qualifiers#subpath" shape: a scheme-like
    // leading word, then `namespace/name`, with optional `@version`, `?qualifiers`,
    // and `#subpath` segments. Heuristic only — not strict purl validation.
