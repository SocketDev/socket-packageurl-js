/**
 * @fileoverview Maven Central registry existence check.
 * Queries Maven Central at search.maven.org to verify package existence.
 */
  ...
  const fetchResult = async (): Promise<ExistsResult> => {
    try {
      ...
      if (version) {
        ...
        const versionData = await httpGetJson<{
