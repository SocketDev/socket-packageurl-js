...
- 🚨 A private package is `0.0.0` and unscoped `<repo>-<dir-path>`; the versioned repo ROOT is exempt - its version is a non-npm channel's release version plus the workspace versionSource. (`scripts/fleet/check/private-packages-are-unpublishable.mts`) [`private-package-identity`](docs/agents.md/fleet/private-package-identity.md)
